...
%    1. \videourl and \repourl are both set. Guide 7 and 9 require the video
%       URL to appear in the report; it does, on the title page and in 6.
...
\newcommand{\videourl}{https://youtu.be/CcPI3QoY-no}
%
...
%    No trailing slash.
\newcommand{\repourl}{https://github.com/Niccc8/rvbl2-riscv-cpu-core}
% *****************************************************************************
...
\begin{figure}[htbp]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.13\linewidth]{figures/soc-architecture.png}}
