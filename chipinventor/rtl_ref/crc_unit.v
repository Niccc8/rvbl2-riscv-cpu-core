...
// (Block Guide S3.1.3: "without latency").
//
// Structure follows Block Guide S3.1.3 literally: three independent CRC
...
//
// OPERAND ROLES (rs1 = data, rs2 = accumulator) - SET BY THE FIRMWARE
// -------------------------------------------------------------------
...
//
// Encoding 0x80848433 confirms it: rs1=9 (s1, holding 0x12), rs2=8 (s0,
// holding the 0xFFFF seed). An earlier revision of this block had the two
// roles the other way round; wired that way the firmware's CRCB chain yields
// 0x1CFF instead of 0x1E82 and _rvbl2_crc_test fails.
//
...
//
// The port LIST is unchanged by this, so nothing on the ChipInventor canvas
// moves: only this block's Code field is repasted.
// ============================================================================
module crc_unit (
