...
// Execute cycle (§5.3/§12.1). funct3 directly drives operand-signedness
// and result-half selection per Table 10 (§12.2):
//
...
// half). Verified by brute-force truth table over all 4 encodings in
// tb_multiplier.v before trusting this formula.
// ============================================================================
module multiplier (
